...
/**
 * set_info - Set fields in the info_t structure based
 ...
 * aliases and variables in the 'argv' array using replace_alias
 *	and replace_vars.
 */
 ...
 * is non-zero, it frees memory associated with 'arg', 'env',
 *	'history', 'alias',
 * 'environ', 'cmd_buf', and closes the file descriptor 'readfd'.
 *	It also flushes
