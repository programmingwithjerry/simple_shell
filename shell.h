 ...
 *@line_count: counts number of error
 ...
 *@alias: Alias node
 *@env_changed: True if environment was changed
 *@status: Returns the status of the last executed cmd
 *@cmd_buf:The address of ptr to cmd_buf, on if chaining
 *@cmd_buf_type: CMD_type ||, &&, ;
 *@readfd: the file descriptor to read line input
 *@histcount: counts history line number
 */
typedef struct passinfo
{
	...
	char **cmd_buf; /*a pointer to cmd ; chain buffer, manages memory */
